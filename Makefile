...
.PHONY: objects
objects: CFLAGS += -fPIC $(MONGOOSE_OPTIONS) -Ideps/.incs -Isrc -Ideps/.incs -Wall -Werror -Wno-parentheses -Wno-pointer-sign -g -O3
objects: $(TARGETS)
...
.PHONY: tests
tests: CFLAGS += -Isrc -Isupport/libut/src -Wno-parentheses -Wno-pointer-sign  -Wno-pointer-to-int-cast -DTHREAD_SAFE -g -O3
